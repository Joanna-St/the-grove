...
### Glamour
- Magical energy — the fuel for the grove's protective ward
...
### Protection
- A separate stat (0–100%) representing the ward generated by the Silvanus statue
- Decays on its own over time — the ward naturally weakens without fuel
...
- Decay rate scales with grove size (more areas = bigger ward to maintain) and is highest when the Feywild Boundary is active
...
- Base passive income scales with protection level — a well-maintained ward means a thriving grove
...
- **Ongoing maintenance:** The Feywild Boundary adds the highest protection decay multiplier in the game — the volatile magical pressure on the ward is real. Neglect it and the statue visibly suffers; tend it and the boundary stabilises.
